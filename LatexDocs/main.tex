...
\textbf{Comparison with Hard QBound on DQN:} While Hard QBound degrades Pendulum DQN by -7.1\%, Soft QBound shows mean improvement for DDPG/TD3. This suggests the QBound type matters: Soft QBound may be more suitable for negative reward environments than Hard QBound.
