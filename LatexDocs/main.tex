...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/qbound_summary_all_experiments.pdf}
\caption{Summary of QBound experiments across all environments. Results show reward-sign dependent effectiveness: positive dense rewards (CartPole) show strong improvement, while sparse terminal rewards (GridWorld, FrozenLake) show minimal benefit, and negative rewards show degradation.}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/gridworld_dqn_static_qbound_5seed.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/frozenlake_dqn_static_qbound_5seed.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/qbound_category_summary.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/gridworld_dqn_static_qbound_5seed.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/frozenlake_dqn_static_qbound_5seed.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/cartpole_dqn_learning_curves.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/cartpole_comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/qbound_summary_all_experiments.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/pendulum_ddpg_full_qbound_5seed.pdf}
