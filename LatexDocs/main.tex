...
\midrule
\textbf{Negative Dense} (Pendulum) & DQN & 55.5\% & -7.1\% & \textbf{Under investigation} \\
\textbf{Negative Dense} (Pendulum) & DDQN & 3.8\% & -7.1\% & \textbf{Under investigation} \\
\textbf{Negative Dense} (Pendulum) & DDPG & 29.7\% & +25.0\% & Soft QBound approach \\
\textbf{Negative Dense} (Pendulum) & TD3 & 3.5\% & +15.3\% & Soft QBound approach \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Recommendation:} Use Hard QBound for positive dense rewards where overestimation causes frequent bound violations. For sparse rewards, violations are rare so QBound provides no benefit. For negative dense rewards, use Soft QBound with DDPG/TD3 (shows +15\% to +25\% improvement).
