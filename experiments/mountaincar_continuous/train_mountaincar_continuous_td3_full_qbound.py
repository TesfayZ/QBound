"""
MountainCarContinuous-v0: TD3 with Soft QBound - Time-Step Dependent Rewards
...
parser = argparse.ArgumentParser(description='TD3 on MountainCarContinuous-v0 with Soft QBound (Time-step Dependent)')
...
RESULTS_FILE = f"/root/projects/QBound/results/mountaincar_continuous/td3_full_qbound_seed{SEED}_in_progress.json"
...
def main():
    print("=" * 80)
    print("MountainCarContinuous-v0: TD3 2-Way Comparison (Time-Step Dependent)")
    ...
    print(f"  Policy noise: {POLICY_NOISE}, Policy freq: {POLICY_FREQ}")
    ...
    if results is None:
        ...
        results = {
            ...
            'script_name': 'train_mountaincar_continuous_td3_full_qbound.py',
            'config': {
                'env': ENV_NAME,
    ...
    final_output_file = f"/root/projects/QBound/results/mountaincar_continuous/td3_full_qbound_seed{SEED}_{timestamp}.json"
    ...
    print("\n" + "=" * 80)
    print("MountainCarContinuous TD3 2-Way Comparison Complete!")
    print("=" * 80)
    print()
    print("📊 Key Takeaways:")
    ...
    print("  - TD3 uses twin critics and delayed policy updates")
