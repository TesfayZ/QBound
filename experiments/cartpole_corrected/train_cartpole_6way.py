...
2. Static QBound + DQN - Q ∈ [0, 100]
3. Dynamic QBound + DQN - Q ∈ [0, Q_max(t)], step-aware DECREASING bounds
4. Baseline DDQN - No QBound, with Double-Q
5. Static QBound + DDQN - Q ∈ [0, 100] + Double-Q
...
def main():
    ...
    print(f"  Dynamic QBound: Q_max(t) = (1 - γ^(H-t)) / (1-γ) [DECREASES as t increases]")
    print("=" * 80)
